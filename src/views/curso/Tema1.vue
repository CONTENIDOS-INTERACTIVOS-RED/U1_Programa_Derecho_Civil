  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.overflow-hidden
    ...
    .row.mb-5
      ...
      .col-12.col-xl-8.d-flex.align-items-center.bg-ppal-claro.p-4
        p.mb-0 El Derecho Civil es una de las ramas del derecho privado, que regula las relaciones entre personas, tanto físicas como jurídicas, en diferentes aspectos de la cotidianidad.
        ...
        SlyderF(columnas="col-12 col-lg-6")
          .row.py-4.px-4.px-lg-3.px-xxl-2.h-100.justify-content-center
            .col-10.col-md-11.col-lg-12.col-xxl-11.px-0
              div.box-shadow.ms-3.h-100
                img(src='@/assets/curso/unidad1/img-16.png' alt='AvatarTop')
                p.mb-0.p-4.text-bold.text-center(style="borderRadius: 0px 0px 18px 18px") El matrimonio
          .row.py-4.px-4.px-lg-3.px-xxl-2.h-100.justify-content-center
            .col-10.col-md-11.col-lg-12.col-xxl-11.px-0
              div.box-shadow.ms-3.h-100
                img(src='@/assets/curso/unidad1/img-17.png' alt='AvatarTop')
                p.mb-0.p-4.text-bold.text-center(style="borderRadius: 0px 0px 18px 18px") El contrato
          .row.py-4.px-4.px-lg-3.px-xxl-2.h-100.justify-content-center
            .col-10.col-md-11.col-lg-12.col-xxl-11.px-0
              div.box-shadow.ms-3.h-100
                img(src='@/assets/curso/unidad1/img-18.png' alt='AvatarTop')
                p.mb-0.p-4.text-bold.text-center(style="borderRadius: 0px 0px 18px 18px") El testamento
          .row.py-4.px-4.px-lg-3.px-xxl-2.h-100.justify-content-center
            .col-10.col-md-11.col-lg-12.col-xxl-11.px-0
              div.box-shadow.ms-3.h-100
                img(src='@/assets/curso/unidad1/img-19.png' alt='AvatarTop')
                p.mb-0.px-4.pb-0.pt-2.text-bold.text-center(style="borderRadius: 0px 0px 18px 18px") El cumplimiento de las obligaciones
          .row.py-4.px-4.px-lg-3.px-xxl-2.h-100.justify-content-center
            .col-10.col-md-11.col-lg-12.col-xxl-11.px-0
              div.box-shadow.ms-3.h-100
                img(src='@/assets/curso/unidad1/img-20.png' alt='AvatarTop')
                p.mb-0.p-4.text-bold.text-center(style="borderRadius: 0px 0px 18px 18px") Los negocios
    ...
    .row.mb-5.justify-content-center(data-aos="zoom-in-up")
      ...
      .col-8.col-sm-7.col-md-6.col-xl-3.mb-4.mb-xl-0
        .custom-image-card.text-small.d-flex.justify-content-center.p-2.h-100
          ...
          p.mb-0.flex-grow-1.d-flex.flex-row.align-items-center Proteger los derechos individuales.
      .col-8.col-sm-7.col-md-6.col-xl-3.mb-4.mb-xl-0
        .custom-image-card.text-small.d-flex.justify-content-center.p-2.h-100
          img.me-3(src='@/assets/curso/unidad1/img-22.svg', style="width: 68px")  
          p.mb-0.flex-grow-1.d-flex.flex-row.align-items-center Regular las relaciones contractuales.
      .col-8.col-sm-7.col-md-6.col-xl-3.mb-4.mb-xl-0
        .custom-image-card.text-small.d-flex.justify-content-center.p-2.h-100
          img.me-3(src='@/assets/curso/unidad1/img-23.svg', style="width: 68px")
          p.mb-0.flex-grow-1.d-flex.flex-row.align-items-center Establecer un marco para la resolución de conflictos entre particulares.
      .col-8.col-sm-7.col-md-6.col-xl-3.mb-4.mb-xl-0
        .custom-image-card.text-small.d-flex.justify-content-center.p-2.h-100
          img.me-3(src='@/assets/curso/unidad1/img-24.svg', style="width: 68px")
          p.mb-0.flex-grow-1.d-flex.flex-row.align-items-center Promover la justicia y la equidad en las transacciones.
        ...
        .tabs-content.border.px-4.p-md-5.py-3(titulo="Derecho Romano")
          .row
            ...
            .col-md-12.col-lg-7.col-xl-8.mb-4.mb-md-0
              h4 Derecho Romano
              p(data-aos="fade-up") Chinchilla (2019), establece que en este se encuentran las relaciones obligatorias de intercambio o de asociatividad y prestaciones de los sujetos. Adicionalmente, esas relaciones tienen como centro la buena fe como motor de creación de reglas, que, a juicio del autor, podían ser la base de reglas de las relaciones. Chinchilla también enfatiza en la relevancia de los vínculos en las sociedades romanas y que esto es un fundamento de cómo se construye la base de las obligaciones en el Derecho Civil.
        .tabs-content.border.px-4.p-md-5.py-3(titulo="Código Napoleónico")
          .row
            .d-none.d-lg-block.col-md-12.col-lg-5.col-xl-4
              figure
                img(src='@/assets/curso/unidad1/img-26.png', alt='Texto que describa la imagen')
            .col-md-12.col-lg-7.col-xl-8.mb-4.mb-md-0
              h4 Código Napoleónico
              p Este es el Código Civil más conocido a nivel global y para algunos implicó el nacimiento de la codificación civil en la modernidad. Así, para distintas naciones, fue un modelo para consolidar el ordenamiento jurídico y la consolidación de fuentes del derecho.
        .tabs-content.border.px-4.p-md-5.py-3(titulo="Código Civil chileno")
          .row
            .d-none.d-lg-block.col-md-12.col-lg-5.col-xl-4
              figure
                img(src='@/assets/curso/unidad1/img-27.png', alt='Texto que describa la imagen')
            .col-md-12.col-lg-7.col-xl-8.mb-4.mb-md-0
              h4 Código Civil chileno
              p Este no solo influenció el código colombiano, sino en general, el derecho en América Latina. Hinestrosa (2021) relata que, en 1873, los Estados Unidos de Colombia adoptaron el Código Civil chileno, redactado por Andrés Bello, con algunas modificaciones y que así también lo hicieron algunas otras naciones hispanoamericanas. Posteriormente, en 1887 y atendiendo a la nueva constitución de 1886, la ley 57 y la ley 153, se hicieron algunas de las modificaciones más relevantes. De ahí a que se considera que su expedición es de 1887.


    .row.justify-content-center.mb-5
      p.mb-5 Además de las mencionadas, Hinestrosa (2021) señala que han habido numerosas reformas dentro de las cuales, a modo de ejemplo, se encuentran: 
          ...
          .row.py-4.px-3.h-100
            .col-10.offset-1.offset-md-0.col-md-12.shadow-app.p-3.py-lg-5.px-md-4
              .row.justify-content-center
                .col-5.col-md-4.mb-4
                  img(src='@/assets/componentes/test-slider.svg' alt='AvatarTop')
                h3.text-center.mb-4 Ley 70 de 1931
                p.text-center Reglamentó la constitución de patrimonios de familia, no embargables.
          .row.py-4.px-3.h-100
            .col-10.offset-1.offset-md-0.col-md-12.shadow-app.p-3.py-lg-5.px-md-4
              .row.justify-content-center
                .col-5.col-md-4.mb-4
    ...
    .row.mb-5.pb-3
      p.mb-5 Los ejemplos de las reformas muestran que incluso existiendo el Código Civil colombiano desde 1887, este se ha adaptado a las nuevas realidades del país y a los cambios configurados en las relaciones entre los sujetos. 
    ...
    p.mb-4 Incluso con estos cambios, vale la pena aclarar que los tópicos centrales se mantienen y que los ajustes que se dan, es sobre la forma en la que se regulan las relaciones. Así, la estructura del Derecho Civil agrupa sus divisiones en la existencia de las personas, sus relaciones familiares, contractuales y de obligaciones.
    p.mb-4 Estas divisiones, conocidas como <strong>subramas</strong>, son: 
        ...
        SlyderA(tipo="b").bg-white
          .row.p-4.px-md-5.py-lg-5
            .col-md-12.col-lg-7.mb-4.mb-md-0
              p.text-bold Derecho de Personas
              p(data-aos="fade-up") El derecho de personas regula a los individuos, su capacidad jurídica y estado civil. Dentro de los aspectos que le son relevantes, incluye el nacimiento, la nacionalidad, la capacidad para actuar y el estado civil (matrimonio, divorcio, etc.).
            .d-none.d-lg-block.col-md-6.col-lg-4
              figure
                img(src='@/assets/curso/unidad1/img-29.png', alt='Texto que describa la imagen')
          .row.p-4.px-md-5.py-lg-5
            .col-md-12.col-lg-7.mb-4.mb-md-0
              p.text-bold Derecho de Familia
              p El derecho de familia aborda las relaciones familiares y las responsabilidades que surgen de ellas. Busca proteger los derechos de quienes la componen y regula el matrimonio, la adopción, la custodia de los hijos y la responsabilidad sobre estos.
            .d-none.d-lg-block.col-md-6.col-lg-4
              figure
                img(src='@/assets/curso/unidad1/img-30.png', alt='Texto que describa la imagen')
          .row.p-4.px-md-5.py-lg-5
            .col-md-12.col-lg-7.mb-4.mb-md-0
              p.text-bold Derecho de Sucesiones
              p El derecho de sucesiones regula la transmisión de bienes y derechos tras el fallecimiento de una persona. Establece las normas para la elaboración de testamentos, la distribución de herencias y los procedimientos sucesorios y así garantizar la seguridad patrimonial de los herederos.
            .d-none.d-lg-block.col-md-6.col-lg-4
              figure
                img(src='@/assets/curso/unidad1/img-31.png', alt='Texto que describa la imagen')
          .row.p-4.px-md-5.py-lg-5
            .col-md-12.col-lg-7.mb-4.mb-md-0
              p.text-bold Derecho de Obligaciones
              p El derecho de obligaciones aborda las relaciones contractuales y las obligaciones que surgen de ellas. Regula la formación, validez y efectos de los contratos, así como los derechos y deberes de las partes involucradas.
            .d-none.d-lg-block.col-md-6.col-lg-4
              figure
                img(src='@/assets/curso/unidad1/img-32.png', alt='Texto que describa la imagen')
          .row.p-4.px-md-5.py-lg-5
            .col-md-12.col-lg-7.mb-4.mb-md-0
              p.text-bold Derecho de Bienes
              p El derecho de propiedad regula los derechos sobre los bienes, tanto muebles como inmuebles. Incluye la adquisición, transmisión y protección de la propiedad, así como los derechos de usufructo y servidumbres. Usualmente, se estudia a la par de las obligaciones.
            .d-none.d-lg-block.col-md-6.col-lg-4
              figure
                img(src='@/assets/curso/unidad1/img-33.png', alt='Texto que describa la imagen')
          .row.p-4.px-md-5.py-lg-5
            .col-md-12.col-lg-7.mb-4.mb-md-0
              p.text-bold Responsabilidad Civil
              p La responsabilidad civil no es estudiada como una subrama del Derecho Civil. Sin embargo, es determinante en la aproximación procesal de esta área. Se centra en la obligación de reparar daños causados a terceros.
            .d-none.d-lg-block.col-md-6.col-lg-4
              figure
                img(src='@/assets/curso/unidad1/img-34.png', alt='Texto que describa la imagen')

    .row.mb-5.pt-5
      h1.mb-4 Relación con otras ramas del Derecho
      p Además de las subramas del Derecho Civil, este también es relevante para otras áreas del derecho privado, como:
    ...
    .row.position-relative.mb-5.py-4.bg-fondo-1.bg-full-width
      div.px-4.px-md-5.py-md-3
        SlyderA(tipo="b").bg-white
          .row.p-4.px-md-5.py-lg-5
            .col-md-12.col-lg-7.mb-4.mb-md-0
              p.text-bold Derecho Comercial
              p(data-aos="fade-up") Las relaciones comerciales, si bien son reguladas por el derecho comercial, están ligadas a los procesos civiles. Esto se explica en que la ejecución de contratos, las transacciones y la responsabilidad sobre los productos tienen fundamentos en normas del proceso civil.
            .d-none.d-lg-block.col-md-6.col-lg-4
              figure
                img(src='@/assets/curso/unidad1/img-35.png', alt='Texto que describa la imagen')
          .row.p-4.px-md-5.py-lg-5
            .col-md-12.col-lg-7.mb-4.mb-md-0
              p.text-bold Derecho Laboral
              p El derecho laboral establece las relaciones entre empleadores y empleados, pero también está intrínsecamente ligado al Derecho Civil en la aplicación de los contratos. Además, la responsabilidad civil es relevante frente a situaciones de incumplimiento laboral y de las ejecuciones en las obligaciones contractuales.
            .d-none.d-lg-block.col-md-6.col-lg-4
              figure
                img(src='@/assets/curso/unidad1/img-36.png', alt='Texto que describa la imagen')
          .row.p-4.px-md-5.py-lg-5
            .col-md-12.col-lg-7.mb-4.mb-md-0
              p.text-bold Derecho Administrativo
              p Las interacciones entre particulares y la administración pública, están reguladas por el derecho administrativo, pero el Derecho Civil puede intervenir en casos donde se afectan derechos individuales, como en la expropiación de propiedades o la regulación de contratos administrativos.
            .d-none.d-lg-block.col-md-6.col-lg-4
              figure
      ...
      .col-12.col-lg-7(data-aos="fade-right")
        AcordionA(tipo="b")
          ...
          .div(titulo="Acceso a la justicia")
            p Todas las personas deben tener garantías para el ejercicio de sus derechos y defensa de sus intereses, así como un debido proceso.
          .div(titulo="Legalidad")
            p El sometimiento de los jueces al dominio de la ley.
          .div(titulo="Debido proceso")
            p Deberá ser aplicado en todas las actuaciones previstas por el Código General del Proceso.
      .col-12.col-lg-5.d-none.d-lg-block
      ...
      .col-12.col-lg-7(data-aos="fade-left")
        AcordionA(tipo="b")
          ...
          .div(titulo="Instancias")
            p Los procesos tendrán dos instancias, salvo en los casos que la ley establezca solo una.
